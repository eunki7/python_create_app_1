...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("C:/Django/workspace/python_class1/section6/resource/title_ico.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("C:/Django/workspace/python_class1/section6/resource/you_viewer_logo.png"))
